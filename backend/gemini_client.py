...
def generate_flashcards(document_text: str) -> str:
    api_key = os.getenv("GEMINI_API_KEY")
    prompt = (
        "You are a study assistant. Generate exactly 5 flashcards from the provided document.\n"
        "Return ONLY a JSON array with exactly 5 objects. Each object must have exactly two keys: "
        "\"question\" and \"answer\".\n"
